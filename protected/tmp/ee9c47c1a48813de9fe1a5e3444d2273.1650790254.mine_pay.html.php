<?php if(!class_exists("View", false)) exit("no direct access allowed");?>		<!--App自定义的css-->
		...
		<header class="mui-bar mui-bar-nav">
			...
			<a href="<?php echo url(array('c'=>'mine', 'a'=>'pay', ));?>"><h1 class="mui-title">我的订单</h1></a>
		</header>
		...
		<div class="mui-content new-min-order">
			...
			<ul>
				...
				<form target="_self" method="post" action="<?php echo url(array('c'=>'mine', 'a'=>'askrefund', ));?>" onsubmit="return confirm('真的要退款吗？');">
